...
"""GCIMentor (Model) query functions.
"""
...
import soc.modules.gci.models.mentor


class Logic(mentor.Logic):
  """Logic methods for the GCIMentor model.
  """

  def __init__(self, model=soc.modules.gci.models.mentor.GCIMentor,
               base_model=soc.models.mentor.Mentor,
               scope_logic=soc.modules.gci.logic.models.organization,
               role_name='gci_mentor', disallow_last_resign=False):
