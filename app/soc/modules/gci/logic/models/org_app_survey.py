...
"""OrgAppSurvey (Model) query functions for the GCI module.
"""
...
from soc.modules.gci.logic.models.org_app_record import logic as \
    org_app_record_logic
from soc.modules.gci.logic.models import program as program_logic


class Logic(org_app_survey.Logic):
  """Logic class for OrgAppSurveys within the GCI module.
  """
