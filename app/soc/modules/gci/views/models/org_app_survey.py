...
from soc.modules.gci.logic.models.student import logic as student_logic
from soc.modules.gci.tasks import org_app_survey as org_app_survey_tasks
from soc.modules.gci.views.helper import access
from soc.modules.gci.views.models.program import view as program_view


class View(org_app_survey.View):
  """View methods for the GCIOrgAppSurveys model.
  """
