...
from soc.modules.gsoc.views.models.program import view as program_view


class View(org_app_survey.View):
  """View methods for the GSoCOrgAppSurveys model.
  """
...
list_self = decorators.view(view.list_self)
