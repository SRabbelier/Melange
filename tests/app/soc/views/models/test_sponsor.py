...
class SponsorTestForDeveloper(DjangoTestCase):
  ...
  def setUp(self):
    ...
    key_name = user_logic.getKeyNameFromFields(properties)
    self.another_user = user_logic.updateOrCreateFromKeyName(properties, key_name)
  ...
  def testCreateProgramOwnerWithScopePath(self):
    """Test that a developer user can create a program owner with empty scope path.
    """
    url = '/sponsor/create/'
    response = self.client.get(url)
    self.assertEqual(response.status_code, httplib.OK)
  ...
  def testEditProgramOwnerSelfExisted(self):
    """Test that a developer user can edit a program owner with a link id (him/herself).
    """
  ...
  def testEditProgramOwnerAnotherExisted(self):
    """Test that a developer user can edit a program owner with a link id (another user).
    """
  ...
  def testEditProgramOwnerNonExisted(self):
    """Test that a developer user cannot edit an non existed program owner with a link id.
    """
  ...
  def testDeleteProgramOwnerSelfExisted(self):
    """Test that the operation that a developer user deletes a program owner (him/herself) through HTTP GET is forbidden.
    """
    sponsor, properties = self.createSponsor(self.user)
  ...
  def testDeleteProgramOwnerAnotherExisted(self):
    """Test that the operation that a developer user deletes a program owner (another user) through HTTP GET is forbidden.
    """
    sponsor, properties = self.createSponsor(self.another_user)
    url = '/sponsor/delete/' + properties.get('link_id')
    response = self.client.get(url)
  ...
  def testDeleteProgramOwnerNonExisted(self):
    """Test that the operation that a developer user deletes a non existed program owner (him/herself) through HTTP GET is forbidden.
    """
    link_id = 'not_a_sponsor'
  ...
  def testShowProgramOwnerSelfExisted(self):
    """Test that a developer user can show an existed program owner with a link id (him/herself).
    """
    sponsor, properties = self.createSponsor(self.user)
  ...
  def testShowProgramOwnerAnotherExisted(self):
    """Test that a developer user can show an existed program owner with a link id (another user).
    """
    sponsor, properties = self.createSponsor(self.another_user)
    url = '/sponsor/show/' + properties.get('link_id')
    response = self.client.get(url)
  ...
  def testShowProgramOwnerNonExisted(self):
    """Test that error is returned if a developer user tries to show an unexisted program owner.
    """
    link_id = 'not_a_sponsor'
  ...
  def testListProgramOwner(self):
    """Test that a developer user can view all existed program owners (sponsors has not been listed/retrieved).
    """
    sponsor, properties = self.createSponsor(self.user)
  ...
  def testListRequestsForProgramOwnerSelfExisted(self):
    """Test that a developer user can list requests for an existed program owner (him/herself).
    """
    sponsor, properties = self.createSponsor(self.user)
    ...
    view_triple = urlresolvers.resolve(url)
    kwargs = view_triple[2]
    self.assertEqual(kwargs.get('page_name', 'a') + ' ' + link_id, response.context[0].get('page_name', 'b'))

  def testListRequestsForProgramOwnerAnotherExisted(self):
    """Test that a developer user can list requests for an existed program owner (another user).
    """
    sponsor, properties = self.createSponsor(self.another_user)
    link_id = properties.get('link_id')
    url = '/sponsor/list_requests/' + link_id
  ...
  def testListRequestsForProgramOwnerNonExisted(self):
    """Test that error is NOT returned if a developer user tries to list requests for an nonexisted program owner.
    """
    link_id = 'not_a_sponsor'
    url = '/sponsor/list_requests/' + link_id
    response = self.client.get(url)
  ...
  def testListRolesForProgramOwnerSelfExisted(self):
    """Test that a developer user can list roles for an existed program owner (him/herself).
    """
    sponsor, properties = self.createSponsor(self.user)
    link_id = properties.get('link_id')
  ...
  def testListRolesForProgramOwnerAnotherExisted(self):
    """Test that a developer user can list roles for an existed program owner (another user).
    """
    sponsor, properties = self.createSponsor(self.another_user)
    link_id = properties.get('link_id')
    url = '/sponsor/list_roles/' + link_id
  ...
  def testListRolesForProgramOwnerNonExisted(self):
    """Test that error is NOT returned if a developer user tries to list roles for an unexisted program owner.
    """
    link_id = 'not_a_sponsor'
    url = '/sponsor/list_roles/' + link_id
    response = self.client.get(url)
  ...
  def testHomeSelf(self):
    """Test that a developer user can show the home page of an existing program owner (him/herself).
    """
    sponsor, properties = self.createSponsor(self.user)
    ...
    expected_redirected_location ='http://testserver/' + 'sponsor/show/' + properties.get('link_id')
    self.assertEqual(actual_redirected_location, expected_redirected_location )

  def testHomeAnother(self):
    """Test that a developer user can show the home page of an existing program owner (another user).
    """
    sponsor, properties = self.createSponsor(self.another_user)
    url = '/sponsor/home/' + properties.get('link_id')
    response = self.client.get(url)
  ...
  def testHomeNonExisted(self):
    """Test that a developer user cannot show the home page of a non-existing program owner.
    """
    link_id = 'not_a_sponsor'
